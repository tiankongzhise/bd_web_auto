...
def navigate_to_agent_creation(account_page: Page,account_name) -> Optional[Page]:
    """导航到智能体创建页面
    ...
    try:
        ...
        qiaocang_page.navigate_to_aiagent(Config.AGENT_CREATION["url"].format(user_id = Config.ACCOUNT_MAPPING[account_name]))
